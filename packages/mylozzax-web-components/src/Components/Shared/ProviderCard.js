...
export class ExchangeServiceProviderCard extends LitElement {
  static get styles() {
    return css`
        ...
        @media screen and (max-width: 548px) {
          ...
          .changenow-logo, .locallozzax-logo {
            width: 100% !important;
  ...
  render() {
    ...
    //             </div>
    //         </div>    
    //         <div class="title-label">Exchange Lozzax for other cryptocurrencies (floating rate)</div>
    //         <div class="description-label">Exchange your Lozzax for any of a number of cryptocurrencies using ChangeNow's floating rate exchange. The floating rate allows you to exchange smaller amounts of Lozzax than fixed rates. With this method of exchange, due to the volitility of cryptocurrency, you may receive an amount that is slightly different to what you expect.</div>
    //     </div>
    //     <div class="provider-card">
    //         <div class="hoverable-cell utility">
    //             <div class="locallozzax-logo provider-logo">

    //             </div>
    //         </div>    
    //         <div class="title-label">Buy Lozzax with LocalLozzax</div>
    //         <div class="description-label">LocalLozzax is a marketplace that allows a user to buy and sell their Lozzax to others.</div>
    //     </div>
    // `;
  }
