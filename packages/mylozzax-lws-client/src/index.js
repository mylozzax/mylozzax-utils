...
class LWSClient {
   ...
   * @param {string} [options.appVersion] - MyLozzax compatible App version. used for checking compatibility.
   */
  constructor (options = {}) {
  ...
  /**
   * Submits the raw transaction to the server to be passed on to the lozzax network.
   * @param {string} tx - The raw transaction generated bt the lozzax client.
   */
  ...
  /**
   * Fetches the latest fiat rates for LOZZ.
