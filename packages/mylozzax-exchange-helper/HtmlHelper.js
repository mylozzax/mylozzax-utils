...
class HtmlHelper {
    ...
    getBaseWalletSelector() {
        ...
        <div data-walletoffset="0" data-walletpublicaddress="47pasa5moXNCSyvvip6sY39VFGYymMhVEXpcaZSaP3hAVNbVXpGu5MVZn9ePeotMRFiJuLq2pB6B3Hm7uWYanyJe1yeSbm9" data-walletlabel="1" data-swatch="6B696B" data-walletbalance="0.00011111" data-walletid="849b2200-991e-11eb-a54c-51789ea8a399" id="selected-wallet" class="hoverable-cell utility selectionDisplayCellView" style="">
                ...
                <div id="selected-wallet-balance" class="description-label">0.00011111 LOZZ   </div>
            </div>
    ...
    newEstimatedNetworkFeeString(fee_JSBigInt = 0) {
        ...
        const estimatedTotalFee_str = lozzax_amount_format_utils.formatMoney(estimatedTotalFee_JSBigInt)
        const estimatedTotalFee_lozzaxAmountDouble = parseFloat(estimatedTotalFee_str)
      
        // const estimatedTotalFee_lozzaxAmountDouble = 0.028
        ...
        const finalizable_formattedAmountString = estimatedTotalFee_str// `${estimatedTotalFee_lozzaxAmountDouble}`
        ...
        <div>
            ...
            <div class="form_field" id="currency-table">
                <table class="full-width">
                    <tr>
                        <td>   
                            <div class="field_title form-field-title">LOZZ to send
            ...
            <div id="locallozzax" style="margin-bottom: 6px"><a href="#" id="locallozzax-anchor" class="clickableLinkButton">Buy Lozzax using LocalLozzax</a></div>
            <div id="indacoin"><a href="#" id="indacoin-anchor" class="clickableLinkButton">Buy Lozzax using Indacoin</a></div>
    ...
    <div id="exchangePage">
        <div class="field_title form-field-title">
            <table class="full-width">
                    ...
                    <td>
                        <div class="field_title form-field-title uppercase">
                            <div style="position: relative; left: 0px; top: 0px; padding: 2px 0 0 0;">
                                ...
                                <div class="currencySelect"><option value="LOZZ" style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;</option></select> 
                            </div>
                        </div>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <div class="field_title form-field-title">Remaining LOZZ payable
                            <div style="position: relative; left: 0px; top: 0px; padding: 2px 0 0 0;">
                                <span class="field_title form-field-title label-spacing" style="margin-top: 0px;">AMOUNT</span>
                                <div id="in_amount_remaining" class="textInput currencyOutput" type="text" placeholder="0.00">Loading</div>
                                <div class="currencySelect"><option value="LOZZ" style="text-align: center;">LOZZ</option>    
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="field_title form-field-title uppercase label-spacing">
                            <div class="" style="position: relative; left: 0px; top: 0px; padding: 2px 0 0 0">
                                ...
                                <div class="currencySelect">
                                    <option value="LOZZ" style="text-align: center;">&nbsp;&nbsp;&nbsp;</option>
                                </div>
                            </div>
                        </div>
                    </td>
        ...
        <div id="lozzaxd-updates" class="validationWindow">
