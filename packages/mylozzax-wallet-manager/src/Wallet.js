...
class Wallet {
  ...
  /**
   * Decodes a lozzax address. It can be passed a primary, integrated or subaddress for validation.
  ...
  /**
   * Broadcasts the transaction to the lozzax network and adds it to  the transaction list
   * @private
   * @param {object} options
   * @returns
   */
  ...
  /**
   * Changes atomic units into lozzax.
   * @param {BigNumber} bigNumber - The atomic lozzax amount to be converted in to lozzax amount.
   * @returns A number string of lozzax amount.
   */
