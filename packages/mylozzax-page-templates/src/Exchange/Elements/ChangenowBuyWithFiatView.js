...
export class ChangenowBuyWithFiatView extends ExchangeNavigationController(LitElement) {
    ...
    async updateSelectedCurrency(event) {
        ...
        let rangeQueryArray = [this.fiatApi.getMinMaxRange(this.inCurrencyCode, "LOZZ"), this.fiatApi.getMinMaxRange("LOZZ", this.inCurrencyCode)]
    ...
    async fireEstimateEvent(event) {
        ...
        let estimateResponse = await this.fiatApi.createExchangeTransaction(this.inCurrencyValue, this.inCurrencyCode, "LOZZ", this.selectedWallet.public_address);
    ...
    constructor() {
        ...
        this.outCurrencyCode = "LOZZ";
        this.outCurrencyName = "Lozzax";
        ...
        //this.setScreenTitle("Buy Lozzax With Fiat");
        this.wallets = [
            {}
        ];
    }
    ...
    async handleCurrencyInputResponse() {
        ...
        try {
            let response = await this.fiatApi.getTransactionEstimate(this.inCurrencyValue, this.inCurrencyCode, "LOZZ");
            let estimateDetails = {};
    ...
    render() {
        ...
        <div id="changenow-buy-with-fiat">
                        ...
                        <div class="form_field" id="currency-table">
                            <table class="full-width">
                                <tbody><tr>
                                    ...
                                    <td>
                                        <!--
                                        <div id="inInputDiv" class="field_title form-field-title"><span id="outCurrencyTickerCode">LOZZ</span> you will receive
            ...
            <div class="form_field" id="estimate-details">
                <!-- {"id":"4900188772","status":"new","email":null,"errors":[],"status_details":null,"from_currency":"GBP","initial_from_currency":"GBP","from_network":null,"from_currency_with_network":null,"from_amount":"0","deposit_type":"VISA_MC1","payout_type":"CRYPTO_THROUGH_CN","expected_from_amount":"75.5555","initial_expected_from_amount":"75.5555","to_currency":"LOZZ","to_network":null,"to_currency_with_network":null,"to_amount":null,"output_hash":null,"expected_to_amount":"0.3075642","location":"ZA","created_at":"2021-09-03T09:13:04.822Z","updated_at":"2021-09-03T09:13:04.822Z","partner_id":"5833338174","external_partner_link_id":null,"estimate_breakdown":{"toAmount":"0.3075642","fromAmount":75.5555,"serviceFees":[{"name":"Bank fee","amount":"3.02222","currency":"GBP"},{"name":"Service fee","amount":"2.25","currency":"GBP"}],"convertedAmount":{"amount":"70.28328","currency":"GBP"},"estimatedExchangeRate":"0.00437606","networkFee":{"amount":"0.001","currency":"LOZZ"}},"payout":{"address":"47joJKcNWs66f6ein9qTTVFyzeGnmBEGWKomSuMmqwaBYGj7gv2RvFRRUy1xtzpn6qE8BBpDnuFbp44qe9X1XmK78vqXaij","extra_id":"1"},"redirect_url":"https://payments.guardarian.com/checkout?tid=4900188772"} -->
                <div class="estimate-wrapper" ?hidden=${ (Object.keys(this.estimateDetails).length > 0) && (Object.keys(this.estimateDetails.expected_to_amount).length == 0) }>
                    ...
                    <div class="estimate-row odd-row">
                        ...
                        <div class="estimate-value">~ ${this.estimateDetails.expected_to_amount} LOZZ</div>    
                    </div>
                    <div class="estimate-row even-row">
                        <div class="estimate-label"></div>
                        <div class="estimate-value">
                            <a @click=${this.redirectToURL} ?hidden=${!this.displayPurchaseButton} class="confirmation-button">Buy LOZZ</a>
