...
//
const MyLozzaxBridgeClass_Base = require('./MyLozzaxBridgeClass_Base')
const MyLozzaxBridge_utils = require('./MyLozzaxBridge_utils')
//
class MyLozzaxCoreBridgeEssentialsClass extends MyLozzaxBridgeClass_Base {
  ...
  is_subaddress (addr, nettype) {
    ...
    return MyLozzaxBridge_utils.ret_val_boolstring_to_bool(ret.retVal)
  }
  ...
  decode_address (address, nettype) {
    ...
    return {
      ...
      isSubaddress: MyLozzaxBridge_utils.ret_val_boolstring_to_bool(ret.isSubaddress)
    }
  }
    ...
    const args =
		{
		  ...
		  wordset_name: MyLozzaxBridge_utils.api_safe_wordset_name(wordset_name)
		}
    const args_str = JSON.stringify(args)
  ...
  validate_components_for_login (
    ...
    return { // calling these out so as to provide a stable ret val interface
      isValid: MyLozzaxBridge_utils.ret_val_boolstring_to_bool(ret.isValid),
      isInViewOnlyMode: MyLozzaxBridge_utils.ret_val_boolstring_to_bool(ret.isInViewOnlyMode),
      pub_viewKey_string: ret.pub_viewKey_string,
      pub_spendKey_string: ret.pub_spendKey_string
    }
  }
...
//
module.exports = MyLozzaxCoreBridgeEssentialsClass
