const MyLozzaxCoreBridgeEssentialsClass = require('./MyLozzaxCoreBridgeEssentialsClass')
const MyLozzaxBridge_utils = require('./MyLozzaxBridge_utils')
const nettype_utils = require("@mylozzax/mylozzax-nettype");
//
class MyLozzaxLibAppBridgeClass extends MyLozzaxCoreBridgeEssentialsClass
{
	...
	async__send_funds(fn_args)
	{
		...
		self._cb_handlers__SendFundsFormSubmission["fromCpp__SendFundsFormSubmission__get_unspent_outs"] = function(req_params)
		{
			...
			req_params.use_dust = MyLozzaxBridge_utils.ret_val_boolstring_to_bool(req_params.use_dust)
		...
		self._cb_handlers__SendFundsFormSubmission["fromCpp__SendFundsFormSubmission__success"] = function(params)
		{
			...
			params.isLOZZAddressIntegrated = MyLozzaxBridge_utils.ret_val_boolstring_to_bool(params.isLOZZAddressIntegrated)
			//
...
module.exports = MyLozzaxLibAppBridgeClass;