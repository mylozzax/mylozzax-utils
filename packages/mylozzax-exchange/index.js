...
class ExchangeFunctions {
    ...
    //    this.apiUrl = "https://api.lozzax.xyz:443/cx";
         this.apiUrl = "https://api.lozzax.xyz/cx";
        // this.apiVersion = "v3";
        // this.currencyToExchange = "lozz2btc";
        this.offer = {};
        this.offer_type = "";
        this.order = {};
    ...
    createOrder(out_address, refund_address, in_currency = "LOZZ", out_currency = "BTC") {
    ...
    getCurrencyPairs(in_currency = "LOZZ") {
        let self = this;
        return new Promise((resolve, reject) => {
            let data = {
