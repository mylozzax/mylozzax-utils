...
const SendFundsController = (superClass) => class extends superClass {
    ...
    connectedCallback() {
        ...
        this.addEventListener('mym-contact-picker-resolve-address', this.resolveAddress);
    }
...
export default SendFundsController;